...
struct NapiBindings(Movable):
    ...
    def __init__(out self):
        ...
        self.create_object = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.set_named_property = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_cb_info = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_value_string_utf8 = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.define_properties = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_value_double = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_double = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.throw_error = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_boolean = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_value_bool = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.typeof_ = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_null = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_undefined = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_array_with_length = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.set_element = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_element = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_array_length = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_property = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.is_array = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_named_property = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.has_named_property = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.call_function = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.open_handle_scope = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.close_handle_scope = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_promise = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.resolve_deferred = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.reject_deferred = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_error = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_async_work = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.queue_async_work = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.delete_async_work = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_int32 = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_value_int32 = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_uint32 = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_value_uint32 = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_int64 = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_value_int64 = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.throw_type_error = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.throw_range_error = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_type_error = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_range_error = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_arraybuffer = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_arraybuffer_info = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.is_arraybuffer = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.detach_arraybuffer = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_buffer = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_buffer_copy = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_buffer_info = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.is_buffer = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_typedarray = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_typedarray_info = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.is_typedarray = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.define_class = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.wrap = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.unwrap = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.remove_wrap = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.new_instance = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_function = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_new_target = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_global = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_reference = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.delete_reference = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.reference_ref = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.reference_unref = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_reference_value = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.open_escapable_handle_scope = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.close_escapable_handle_scope = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.escape_handle = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_bigint_int64 = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_bigint_uint64 = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_value_bigint_int64 = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_value_bigint_uint64 = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_date = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_date_value = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.is_date = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_symbol = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.symbol_for = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_property_names = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_all_property_names = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.has_own_property = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.delete_property = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.strict_equals = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.instanceof_ = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.object_freeze = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.object_seal = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.has_element = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.delete_element = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_prototype = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_threadsafe_function = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.call_threadsafe_function = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.acquire_threadsafe_function = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.release_threadsafe_function = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_external = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_value_external = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_version = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_node_version = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.set_property = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.has_property = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.throw_ = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.is_exception_pending = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_and_clear_last_exception = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.coerce_to_bool = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.coerce_to_number = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.coerce_to_string = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.coerce_to_object = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_dataview = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_dataview_info = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.is_dataview = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_bigint_words = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_value_bigint_words = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.add_finalizer = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_external_arraybuffer = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.set_instance_data = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_instance_data = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.add_env_cleanup_hook = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.remove_env_cleanup_hook = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.cancel_async_work = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.is_error = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.adjust_external_memory = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.run_script = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.throw_syntax_error = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_syntax_error = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.is_detached_arraybuffer = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.fatal_exception = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.type_tag_object = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.check_object_type_tag = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.add_async_cleanup_hook = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.remove_async_cleanup_hook = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.get_uv_event_loop = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.async_init = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.async_destroy = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.make_callback = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.open_callback_scope = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.close_callback_scope = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_external_string_latin1 = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_external_string_utf16 = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_property_key_utf8 = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_property_key_latin1 = OpaquePointer[MutAnyOrigin].unsafe_dangling()
        self.create_property_key_utf16 = OpaquePointer[MutAnyOrigin].unsafe_dangling()
