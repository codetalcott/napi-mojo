...
def init_bindings(mut bindings: NapiBindings) raises:
    ...
    var _object_freeze = h.get_function[def(NapiEnv, NapiValue) -> NapiStatus](
        "napi_object_freeze"
    )
    ...
    # 86. napi_object_seal
    var _object_seal = h.get_function[def(NapiEnv, NapiValue) -> NapiStatus](
        "napi_object_seal"
    )
    ...
    # 100. napi_throw
    var _throw = h.get_function[def(NapiEnv, NapiValue) -> NapiStatus](
        "napi_throw"
    )
