...
struct JsTypedArray:
    ...
    @staticmethod
    def create_float64(env: NapiEnv, arraybuffer: NapiValue, offset: UInt, length: UInt) raises -> JsTypedArray:
    ...
    @staticmethod
    def create_float64(b: Bindings, env: NapiEnv, arraybuffer: NapiValue, offset: UInt, length: UInt) raises -> JsTypedArray:
        var result = NapiValue()
    ...
    @staticmethod
    def create_uint8(env: NapiEnv, arraybuffer: NapiValue, offset: UInt, length: UInt) raises -> JsTypedArray:
        var result = NapiValue()
    ...
    @staticmethod
    def create_uint8(b: Bindings, env: NapiEnv, arraybuffer: NapiValue, offset: UInt, length: UInt) raises -> JsTypedArray:
        var result = NapiValue()
    ...
    @staticmethod
    def create_int32(env: NapiEnv, arraybuffer: NapiValue, offset: UInt, length: UInt) raises -> JsTypedArray:
        var result = NapiValue()
    ...
    @staticmethod
    def create_int32(b: Bindings, env: NapiEnv, arraybuffer: NapiValue, offset: UInt, length: UInt) raises -> JsTypedArray:
        var result = NapiValue()
    ...
    @staticmethod
    def create_int8(env: NapiEnv, arraybuffer: NapiValue, offset: UInt, length: UInt) raises -> JsTypedArray:
        var result = NapiValue()
    ...
    @staticmethod
    def create_int8(b: Bindings, env: NapiEnv, arraybuffer: NapiValue, offset: UInt, length: UInt) raises -> JsTypedArray:
        var result = NapiValue()
    ...
    @staticmethod
    def create_uint8_clamped(env: NapiEnv, arraybuffer: NapiValue, offset: UInt, length: UInt) raises -> JsTypedArray:
        var result = NapiValue()
    ...
    @staticmethod
    def create_uint8_clamped(b: Bindings, env: NapiEnv, arraybuffer: NapiValue, offset: UInt, length: UInt) raises -> JsTypedArray:
        var result = NapiValue()
    ...
    @staticmethod
    def create_int16(env: NapiEnv, arraybuffer: NapiValue, offset: UInt, length: UInt) raises -> JsTypedArray:
        var result = NapiValue()
    ...
    @staticmethod
    def create_int16(b: Bindings, env: NapiEnv, arraybuffer: NapiValue, offset: UInt, length: UInt) raises -> JsTypedArray:
        var result = NapiValue()
    ...
    @staticmethod
    def create_uint16(env: NapiEnv, arraybuffer: NapiValue, offset: UInt, length: UInt) raises -> JsTypedArray:
        var result = NapiValue()
    ...
    @staticmethod
    def create_uint16(b: Bindings, env: NapiEnv, arraybuffer: NapiValue, offset: UInt, length: UInt) raises -> JsTypedArray:
        var result = NapiValue()
    ...
    @staticmethod
    def create_uint32(env: NapiEnv, arraybuffer: NapiValue, offset: UInt, length: UInt) raises -> JsTypedArray:
        var result = NapiValue()
    ...
    @staticmethod
    def create_uint32(b: Bindings, env: NapiEnv, arraybuffer: NapiValue, offset: UInt, length: UInt) raises -> JsTypedArray:
        var result = NapiValue()
    ...
    @staticmethod
    def create_float32(env: NapiEnv, arraybuffer: NapiValue, offset: UInt, length: UInt) raises -> JsTypedArray:
        var result = NapiValue()
    ...
    @staticmethod
    def create_float32(b: Bindings, env: NapiEnv, arraybuffer: NapiValue, offset: UInt, length: UInt) raises -> JsTypedArray:
        var result = NapiValue()
    ...
    @staticmethod
    def create_bigint64(env: NapiEnv, arraybuffer: NapiValue, offset: UInt, length: UInt) raises -> JsTypedArray:
        var result = NapiValue()
    ...
    @staticmethod
    def create_bigint64(b: Bindings, env: NapiEnv, arraybuffer: NapiValue, offset: UInt, length: UInt) raises -> JsTypedArray:
        var result = NapiValue()
    ...
    @staticmethod
    def create_biguint64(env: NapiEnv, arraybuffer: NapiValue, offset: UInt, length: UInt) raises -> JsTypedArray:
        var result = NapiValue()
    ...
    @staticmethod
    def create_biguint64(b: Bindings, env: NapiEnv, arraybuffer: NapiValue, offset: UInt, length: UInt) raises -> JsTypedArray:
        var result = NapiValue()
    ...
    def data_ptr_float64(self, env: NapiEnv) raises -> UnsafePointer[Float64, MutAnyOrigin]:
        var t: Int32 = 0
        var data = OpaquePointer[MutAnyOrigin]()
        var null = OpaquePointer[MutAnyOrigin]()
        check_status(raw_get_typedarray_info(env, self.value,
    ...
    def data_ptr_float64(self, b: Bindings, env: NapiEnv) raises -> UnsafePointer[Float64, MutAnyOrigin]:
        var t: Int32 = 0
        var data = OpaquePointer[MutAnyOrigin]()
        var null = OpaquePointer[MutAnyOrigin]()
        check_status(raw_get_typedarray_info(b, env, self.value,
    ...
    def data_ptr_float32(self, env: NapiEnv) raises -> UnsafePointer[Float32, MutAnyOrigin]:
        var t: Int32 = 0
        var data = OpaquePointer[MutAnyOrigin]()
        var null = OpaquePointer[MutAnyOrigin]()
        check_status(raw_get_typedarray_info(env, self.value,
    ...
    def data_ptr_float32(self, b: Bindings, env: NapiEnv) raises -> UnsafePointer[Float32, MutAnyOrigin]:
        var t: Int32 = 0
        var data = OpaquePointer[MutAnyOrigin]()
        var null = OpaquePointer[MutAnyOrigin]()
        check_status(raw_get_typedarray_info(b, env, self.value,
    ...
    def data_ptr_int32(self, env: NapiEnv) raises -> UnsafePointer[Int32, MutAnyOrigin]:
        var t: Int32 = 0
        var data = OpaquePointer[MutAnyOrigin]()
        var null = OpaquePointer[MutAnyOrigin]()
        check_status(raw_get_typedarray_info(env, self.value,
    ...
    def data_ptr_int32(self, b: Bindings, env: NapiEnv) raises -> UnsafePointer[Int32, MutAnyOrigin]:
        var t: Int32 = 0
        var data = OpaquePointer[MutAnyOrigin]()
        var null = OpaquePointer[MutAnyOrigin]()
        check_status(raw_get_typedarray_info(b, env, self.value,
    ...
    def data_ptr_uint8(self, env: NapiEnv) raises -> UnsafePointer[UInt8, MutAnyOrigin]:
        var t: Int32 = 0
        var data = OpaquePointer[MutAnyOrigin]()
        var null = OpaquePointer[MutAnyOrigin]()
        check_status(raw_get_typedarray_info(env, self.value,
    ...
    def data_ptr_uint8(self, b: Bindings, env: NapiEnv) raises -> UnsafePointer[UInt8, MutAnyOrigin]:
        var t: Int32 = 0
        var data = OpaquePointer[MutAnyOrigin]()
        var null = OpaquePointer[MutAnyOrigin]()
        check_status(raw_get_typedarray_info(b, env, self.value,
