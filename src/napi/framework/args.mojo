...
struct BindingsAndThree:
    ...
    def __init__(out self, b: Bindings, arg0: NapiValue, arg1: NapiValue, arg2: NapiValue):
        self.b = b
        self.arg0 = arg0
        self.arg1 = arg1
        self.arg2 = arg2
...
struct CbArgs:
    ...
    @staticmethod
    def get_two(env: NapiEnv, info: NapiValue) raises -> InlineArray[NapiValue, 2]:
        var argc: UInt = 2
    ...
    @staticmethod
    def get_two(b: Bindings, env: NapiEnv, info: NapiValue) raises -> InlineArray[NapiValue, 2]:
        var argc: UInt = 2
        var args = InlineArray[NapiValue, 2](fill=NapiValue())
        var null = OpaquePointer[MutAnyOrigin]()
        check_status(raw_get_cb_info(
    ...
    @staticmethod
    def get_three(b: Bindings, env: NapiEnv, info: NapiValue) raises -> InlineArray[NapiValue, 3]:
        var argc: UInt = 3
    ...
    @staticmethod
    def get_four(b: Bindings, env: NapiEnv, info: NapiValue) raises -> InlineArray[NapiValue, 4]:
        var argc: UInt = 4
    ...
    @staticmethod
    def get_this(b: Bindings, env: NapiEnv, info: NapiValue) raises -> NapiValue:
        var argc: UInt = 0
        var this_val: NapiValue = NapiValue()
        var null = OpaquePointer[MutAnyOrigin]()
        check_status(raw_get_cb_info(
    ...
    @staticmethod
    def get_this_and_one(env: NapiEnv, info: NapiValue) raises -> InlineArray[NapiValue, 2]:
        var argc: UInt = 1
        var arg0: NapiValue = NapiValue()
        var this_val: NapiValue = NapiValue()
        var null = OpaquePointer[MutAnyOrigin]()
    ...
    @staticmethod
    def get_this_and_one(b: Bindings, env: NapiEnv, info: NapiValue) raises -> InlineArray[NapiValue, 2]:
        var argc: UInt = 1
        var arg0: NapiValue = NapiValue()
        var this_val: NapiValue = NapiValue()
        var null = OpaquePointer[MutAnyOrigin]()
    ...
    @staticmethod
    def get_argv(env: NapiEnv, info: NapiValue, count: UInt,
    ...
    @staticmethod
    def get_argv(b: Bindings, env: NapiEnv, info: NapiValue, count: UInt,
                argv_ptr: UnsafePointer[NapiValue, MutAnyOrigin]) raises:
        var actual = count
        var null = OpaquePointer[MutAnyOrigin]()
        check_status(raw_get_cb_info(
    ...
    @staticmethod
    def get_data(env: NapiEnv, info: NapiValue) raises -> OpaquePointer[MutAnyOrigin]:
        var argc: UInt = 0
    ...
    @staticmethod
    def get_data(b: Bindings, env: NapiEnv, info: NapiValue) raises -> OpaquePointer[MutAnyOrigin]:
        var argc: UInt = 0
        var data = OpaquePointer[MutAnyOrigin]()
        var null = OpaquePointer[MutAnyOrigin]()
        check_status(raw_get_cb_info(
    ...
    @staticmethod
    def get_bindings_and_one(env: NapiEnv, info: NapiValue) raises -> BindingsAndOne:
        var argc: UInt = 1
        var arg0: NapiValue = NapiValue()
        var data = OpaquePointer[MutAnyOrigin]()
        var null = OpaquePointer[MutAnyOrigin]()
    ...
    @staticmethod
    def get_bindings_and_two(env: NapiEnv, info: NapiValue) raises -> BindingsAndTwo:
        var argc: UInt = 2
        var args = InlineArray[NapiValue, 2](fill=NapiValue())
        var data = OpaquePointer[MutAnyOrigin]()
        var null = OpaquePointer[MutAnyOrigin]()
    ...
    @staticmethod
    def get_bindings_and_three(env: NapiEnv, info: NapiValue) raises -> BindingsAndThree:
        var argc: UInt = 3
        var args = InlineArray[NapiValue, 3](fill=NapiValue())
        var data = OpaquePointer[MutAnyOrigin]()
        var null = OpaquePointer[MutAnyOrigin]()
    ...
    @staticmethod
    def get_bindings_and_this(env: NapiEnv, info: NapiValue) raises -> BindingsAndThis:
        var argc: UInt = 0
        var this_val: NapiValue = NapiValue()
        var data = OpaquePointer[MutAnyOrigin]()
        var null = OpaquePointer[MutAnyOrigin]()
    ...
    @staticmethod
    def get_bindings_this_and_one(env: NapiEnv, info: NapiValue) raises -> BindingsThisAndOne:
        var argc: UInt = 1
        var arg0: NapiValue = NapiValue()
        var this_val: NapiValue = NapiValue()
        var data = OpaquePointer[MutAnyOrigin]()
