...
production. The API covers the full N-API v10 surface (155 exported functions, 5
...
- **155 exported functions** and **5 classes** covering the full **N-API v10** surface (Node.js 22.12+ / 24+)
