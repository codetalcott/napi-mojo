...
function hostEntrySource(moduleName) {
...
from ${moduleName} import mojo_main
...
function cmdRun(argv) {
  ...
  try {
    writeFileSync(wrapper, hostEntrySource(moduleName));
    ...
    const bres = spawnSync(mojo[0], args, { stdio: 'inherit' });
    if (bres.error) {
